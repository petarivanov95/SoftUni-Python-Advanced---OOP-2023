...
# print(f'Secondary diagonal: sum = {" + ".join(list(map(str,primary)))} = {sum_primary}')
# print(f'Secondary diagonal: sum = {" + ".join(list(map(str,secondary)))} = {sum_secondary}')
# print(f'Difference: |{sum_primary} - {sum_secondary}| = {difference}')
print(difference)